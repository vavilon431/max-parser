...
_RU_EXTRA = {
    ...
    # Місяці — часто проскакують через дати ("19 мая", "в июле")
    "январь","февраль","март","апрель","май","июнь",
    "июль","август","сентябрь","октябрь","ноябрь","декабрь",
    # Адміністративно-географічне (нейтральне, не специфічне для тематики)
    "город","житель","территория","регион","страна","центр","область",
    "проект","программа","ситуация","направление","решение","объект",
    "работа","деятельность",
    # Соціально-побутове (без тематичного навантаження)
    "жизнь","сила","школа","сотрудник","водитель","участник","участие","участок",
    "компания","фирма","организация",
    # Прикметники-міхури
    "важный","нужный","главный","последний","большой","новый",
    # Мета-слова постів (підписи, реклама, заклики)
    "подписаться","подписка","реклама","ссылка","источник","репост",
    # Лічильні / квантори
    "число","тысяча","миллион","миллиард","количество","сумма",
    # Загальні дії та терміни (нетематичне зайве)
    "движение","связь","встреча","глава","руководитель",
    # Назва платформи MAX (сам по собі шум — "переходите в МАХ", "купить в MAX")
    "max","мах",
}
